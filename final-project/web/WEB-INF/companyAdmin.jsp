    ...
    <body>
        ...
        <table>
            ...
            <c:forEach items="${users}" var="user">
                <tr>
                    ...
                    <td>
                        <form action="company_admin" method="post">
                    ...
                    <td>
                        <form action="company_admin" method="get">
        ...
        <c:if test="${selectedUser eq null}">
            ...
            <form action="company_admin" method="post">
                ...
                Company: <c:forEach items="${companys}" var="company">
                    <c:if test="${companyId eq company.companyId}">${company.companyName}</c:if>
                </c:forEach><br>
            ...
            <form action="company_admin" method="post">
                ...
                Role: <select name="role">
                    <c:forEach items="${companyRoles}" var="companyRole">
                        <option value="${companyRole.roleId}"
                                <c:if test="${selectedUser.role eq companyRole.roleId}">
                                    selected
                                </c:if>
                                >${companyRole.roleName}</option>
                    </c:forEach>
                </select><br>
                Company: <c:forEach items="${companys}" var="company">
                    <c:if test="${selectedUser.company eq company.companyId}">${company.companyName}</c:if>
                </c:forEach><br>
